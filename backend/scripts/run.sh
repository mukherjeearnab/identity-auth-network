...
docker exec -it cli bash ./scripts/channel/join-peer.sh peer0 identityauthority RTOMSP 8051 1.0

CC="identity_cc"

docker exec -it cli bash ./scripts/install-cc/install-onpeer-cc.sh $CC peer0 citizen CitizenMSP 7051 1.0
docker exec -it cli bash ./scripts/install-cc/install-onpeer-cc.sh $CC peer0 identityauthority RTOMSP 8051 1.0
